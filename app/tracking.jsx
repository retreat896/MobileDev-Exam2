...
export default function VisionCameraExample() {
    ...
    const frameProcessor = useSkiaFrameProcessor((frame) => {
        ...
        const lowerBound = OpenCV.createObject(ObjectType.Scalar, 35, 80, 80);
        const upperBound = OpenCV.createObject(ObjectType.Scalar, 85, 255, 255);
        ...
        OpenCV.invoke('findContours', grayChannel, contours, RetrievalModes.RETR_TREE, ContourApproximationModes.CHAIN_APPROX_SIMPLE);
